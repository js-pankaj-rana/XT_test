...
export const NewsRow = ({ value, voteIncrement, removeNewsObject }) => {
  let { num_comments, created_at, title, url, author, points, objectID } =
    value;
  return (
    <tr id={objectID}>
      ...
      <td className="news-cell text-center">{points ? points : "-"}</td>
      <td className="news-cell text-center">
        <i
          className="icon icon-upward"
